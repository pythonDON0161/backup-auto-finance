...
const CACreditGrade = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    const body = {
      "application": {
        "coAppGradeYourCredit": data.caCreditGrade,
      }
    }
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Heading>Which of the Following Best Applied to You?</Heading>
        <div className="mb-5">
        ...
        <label>
          ...
          <Select
            ...
            defaultValue={state.data.caCreditGrade}
          ...
          <SimpleGrid columns={1} spacing="20px">
            ...
            <Center>
              <Button
                onClick={() =>
                  loginWithRedirect({
                    redirectUri: `${window.location.origin}/ca-grade-your-credit`,
                  })
                }
              >
                Log In/Sign Up
...
export default withRouter(CACreditGrade);
